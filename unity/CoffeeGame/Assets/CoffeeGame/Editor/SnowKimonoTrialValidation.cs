...
{
    public static class SnowKimonoTrialValidation
    {
        private const string ModelPath = "Assets/CoffeeGame/Resources/Models/Hero/snow-kimono.fbx";
        private const string ControllerPath = "Assets/CoffeeGame/Resources/Animations/Hero/SnowKimonoRuntime.controller";
        ...
        public static void Validate()
        {
            ...
            {
                throw new InvalidOperationException("Snow Kimono model or controller did not import.");
            }
            ...
            GameObject holder = new GameObject("Snow Kimono Unity Validation");
            ...
            visual.Initialize(instance.transform, controller, CharacterModelStyle.SnowKimono, camera, 1f, 0f, 180f);
            ...
            Debug.Log("SNOW_KIMONO_UNITY_VALIDATION=" + JsonUtility.ToJson(report));

            UnityEngine.Object.DestroyImmediate(holder);
            UnityEngine.Object.DestroyImmediate(camera.gameObject);
            if (!report.passed)
            {
                throw new InvalidOperationException("Snow Kimono Unity validation failed. See " + reportPath);
            }
        }
        ...
        {
            GameObject cameraObject = new GameObject("Snow Kimono Validation Camera");
            ...
            CreateLight(cameraObject.transform, "Snow Kimono Key", new Vector3(-2f, 3.2f, -2.5f), 1.6f, new Color(1f, 0.83f, 0.76f));
            CreateLight(cameraObject.transform, "Snow Kimono Rim", new Vector3(1.8f, 2.6f, 2.4f), 1.2f, new Color(0.45f, 0.72f, 1f));
            return camera;
        }
        ...
        {
            return Path.Combine(RepositoryRoot(), "art", "3d", "trials", "snow-kimono", "previews", "unity-unlit-palette-diagnostic.png");
        }

        private static string ReportPath()
        {
            return Path.Combine(RepositoryRoot(), "art", "3d", "trials", "snow-kimono", "manifests", "snow-kimono-unity-validation.json");
        }
