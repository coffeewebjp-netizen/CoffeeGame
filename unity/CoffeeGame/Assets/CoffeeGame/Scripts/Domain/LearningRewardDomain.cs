...
namespace CoffeeGame.Domain
{
    ...
    /// <summary>
    /// Skeleton-only balance. The ID makes persistence/replay behavior explicit while values
    /// remain provisional and must not be treated as final economy tuning.
    /// </summary>
    public sealed class ProvisionalLearningRewardPolicyV1
    {
        public const string PolicyId = "coffee-game-rival-reward-v0.1-provisional";
    ...
    public sealed class LearningRewardAggregate
    {
        ...
        private readonly ProvisionalLearningRewardPolicyV1 policy;
        ...
        public LearningRewardAggregate(
            ...
            ProvisionalLearningRewardPolicyV1 policy = null,
            IEnumerable<string> previouslyConsumedGrantIds = null)
        {
            ...
            this.policy = policy ?? new ProvisionalLearningRewardPolicyV1();
