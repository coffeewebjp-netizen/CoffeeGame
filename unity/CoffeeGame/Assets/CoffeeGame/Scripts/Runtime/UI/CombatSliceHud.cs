    ...
    public sealed partial class CombatSliceHud : MonoBehaviour
    {
        ...
        private void DrawInputDiagnostic()
        {
            ...
            GUI.Label(new Rect(panel.x + 12f, panel.y + 105f, panel.width - 24f, 42f),
                $"Jump {input.GetActiveControllerBindingDescription(GameInputSemantic.Jump)}\nSword {input.GetActiveControllerBindingDescription(GameInputSemantic.Sword)}  |  Iai {input.GetActiveControllerBindingDescription(GameInputSemantic.Special)}  |  Ice {input.GetActiveControllerBindingDescription(GameInputSemantic.Magic)}  |  Dodge {input.GetActiveControllerBindingDescription(GameInputSemantic.Dodge)}  |  Guard {input.GetActiveControllerBindingDescription(GameInputSemantic.Guard)}",
                smallStyle);
        }
