...
namespace CoffeeGame.UI
{
    ...
    public sealed class CombatGameHudView : MonoBehaviour
    {
        ...
        {
            if (coffeeLearningStatusText == null || controlButtons.Count < 13)
            {
                return;
            }
            ...
            if (coffeeLearningConnection == null)
            {
                ...
                controlButtons[10].GetComponentInChildren<Text>().text = "CoffeeLearning\u3068\u63a5\u7d9a";
                controlButtons[10].interactable = false;
                controlButtons[11].GetComponentInChildren<Text>().text = "CoffeeLearning\u63a5\u7d9a\u3092\u89e3\u9664";
                controlButtons[11].interactable = false;
                controlButtons[12].GetComponentInChildren<Text>().text = "CoffeeLearning\u64cd\u4f5c\u3092\u30ad\u30e3\u30f3\u30bb\u30eb";
                controlButtons[12].interactable = false;
                return;
            }

            coffeeLearningStatusText.text = "CoffeeLearning: " + coffeeLearningConnection.StatusLabel;
            controlButtons[10].GetComponentInChildren<Text>().text = coffeeLearningConnection.PrimaryActionLabel;
            controlButtons[11].GetComponentInChildren<Text>().text = coffeeLearningConnection.DisconnectActionLabel;
            controlButtons[12].GetComponentInChildren<Text>().text = coffeeLearningConnection.CancelActionLabel;
            controlButtons[10].interactable = !rebinding && coffeeLearningConnection.CanUsePrimaryAction;
            controlButtons[11].interactable = !rebinding && coffeeLearningConnection.CanUseDisconnectAction;
            controlButtons[12].interactable = !rebinding && coffeeLearningConnection.CanUseCancelAction;
        }
