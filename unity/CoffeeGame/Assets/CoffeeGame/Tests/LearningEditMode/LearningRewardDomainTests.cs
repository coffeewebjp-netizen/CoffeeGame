...
namespace CoffeeGame.Domain.Tests
{
    public sealed class LearningRewardDomainTests
    {
        ...
        [Test]
        public void ProvisionalPolicy_MapsEverySemanticBandAndLevelDeterministically()
        {
            var policy = new ProvisionalLearningRewardPolicyV1();
            ...
            Assert.That(ProvisionalLearningRewardPolicyV1.PolicyId,
                Does.Contain("provisional"));
        }
