...
namespace CoffeeGame.Integration.Tests
{
    public sealed class CoffeeGameV1FixtureTests
    {
        ...
        public void FrozenProviderFixture_DeserializesWithExactV1Fields()
        {
            ...
            Assert.That(fixture.accountIdentity.request.path, Is.EqualTo("/api/integrations/coffee-game/v1/account"));
            Assert.That(
                fixture.accountIdentity.response.account.email,
                Is.EqualTo("coffee-game-fixture@example.com"));
            Assert.That(fixture.weakSync.request.query.lookbackDays, Is.EqualTo(14));
            CoffeeGameContractV1.RequireSupportedWeakLookbackDays(
                fixture.weakSync.request.query.lookbackDays);
            ...
            Assert.That(
                fixture.resultRecovery.response.result.judgment.feedback,
                Is.EqualTo("回答の意味が問題の意図と一致しています。"));
            Assert.That(
        ...
        public sealed class CoffeeGameV1FixtureDto
        {
            ...
            public AccountIdentityFixtureDto accountIdentity;
        ...
        [Serializable]
        public sealed class AccountIdentityFixtureDto
        {
            public ResultRecoveryRequestMetadataDto request;
            public AccountIdentityResponseDto response;
        }
